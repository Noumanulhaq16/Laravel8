        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <!--   id="kt_account_profile_details_form"   begin::Form-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="image-input image-input-outline" data-kt-image-input="true"
                                        style="background-image: url('../assets/media/svg/avatars/blank.html')">
                                        <!--begin::Preview existing avatar-->
                                        <div class="image-input-wrapper w-125px h-125px"
                                            style="background-image: url('{{"/uploads/user/profile/".$user->image}}')"></div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="language"
                                        class="form-control form-control-lg form-control-solid" placeholder="Language"
                                        value="{{ $user->language }}" />
                                </div>
                                <!--end::Col-->
                            </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="fv-row mb-0">
                                                ...
                                                <input type="password"
                                                    ...
                                                    <span class="text-danger">{{$errors->first('current_password
                                                    ')}}</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
